 ...
 * ```
 */
export declare class StockChartStripLineDirective extends ComplexBase<StockChartStripLineDirective> {
 ...
 * @private
 */
export declare class StockChartStripLinesDirective extends ArrayBase<StockChartStripLinesDirective> {
    constructor();
}
