...
/** @hidden */
export declare const exportGroupCaption: string;
/**
...
/** @hidden */
export declare const beforeFltrcMenuOpen: string;
/** @hidden */
export declare const valCustomPlacement: string;
/** @hidden */
export declare const filterCboxValue: string;
